      ...
      <form onSubmit={handleUpdate}>
        ...
        <input
          ...
          onChange={(e) =>
            setForm({
              ...form,
              contractor: { ...form.contractor, name: e.target.value },
            })
          }
        />
        <input
          ...
          onChange={(e) =>
            setForm({
              ...form,
              contractor: { ...form.contractor, contact: e.target.value },
            })
          }
        />
        ...
        <input
          ...
          onChange={(e) =>
            setForm({ ...form, budget: { amount: e.target.value } })
          }
        />

        <br />
        <button type="submit">Simpan Perubahan</button>
        <button type="button" onClick={() => router.push("/project")}>
          Batal
        </button>
      </form>
    </div>
