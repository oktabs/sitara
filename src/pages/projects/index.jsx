...
export default function ProjectsPage() {
  ...
  const [form, setForm] = useState({
    ...
    startDate: '',
    endDate: '',
    budget: { fiscalYear: '', fundingSource: 'APBD' }
  });
      ...
      <div className="max-w-7xl mx-auto p-6 pt-32">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Buat, kelola, dan pantau proyek pembangunan pemerintah secara real‑time
          </p>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 mb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, budget: { ...form.budget, fiscalYear: e.target.value } })}
                    />
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm({ ...form, budget: { ...form.budget, fundingSource: e.target.value } })}
                    >
            ...
            <div className="bg-blue-50/50 p-6 rounded-xl">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Detail Lokasi</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, location: { ...form.location, province: e.target.value } })}
                />
                <input
                  className="border border-gray-200 p-4 rounded-xl text-black placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, location: { ...form.location, village: e.target.value } })}
                />
              </div>
            ...
            <div className="bg-green-50/50 p-6 rounded-xl">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Informasi Kontraktor</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, contractor: { ...form.contractor, name: e.target.value } })}
                />
                <input
                  className="border border-gray-200 p-4 rounded-xl text-black placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  ...
                  onChange={(e) =>
                    setForm({ ...form, contractor: { ...form.contractor, contact: e.target.value } })}
                />
              </div>
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, contractor: { ...form.contractor, address: e.target.value } })}
              />
            </div>
            ...
            <button
              ...
              type="submit"
            >
              {editingId ? 'Perbarui Proyek' : 'Buat Proyek'}
            </button>
          </form>
        </div>
        ...
        {/* Daftar Proyek */}
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">Daftar Proyek</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
